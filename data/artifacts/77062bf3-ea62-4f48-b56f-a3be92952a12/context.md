...
**Keywords**: tests, assertionerror, test_failure, test, test_discount_rounding_over_http, test_pricing, failing, analyze, minimal, output, modify, failed, assert, apply, patch
...
### tests/test_pricing.py (score=64)
```python
