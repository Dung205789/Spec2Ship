...
**Keywords**: assertionerror, test_failure, tests, test_discount_rounding_over_http, implementation, test_pricing, docstrings, constants, refactor, extract, numbers, failed, assert, magic, green
