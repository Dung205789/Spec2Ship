...
$Pricing = Join-Path $Root "sample_workspace\tinyshop\pricing.py"
...
'@ | Set-Content -Encoding UTF8 $Pricing

Write-Host "Reset sample workspace: pricing bug restored" -ForegroundColor Green
